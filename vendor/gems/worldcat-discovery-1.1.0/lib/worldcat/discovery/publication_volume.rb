...
module WorldCat
  module Discovery
    ...
    # 
    # [volume_number] RDF predicate: http:/schema.org/issueNumber; returns: Integer
    # [type] RDF predicate: http://www.w3.org/1999/02/22-rdf-syntax-ns#type; returns: RDF::URI
    #
    
    class PublicationVolume < Spira::Base
      
      property :volume_number, :predicate => SCHEMA_VOLUME_NUMBER, :type => XSD.integer
